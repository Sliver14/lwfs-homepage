...
const BottomNav = () => {
    ...
    const Navbar = [
        { name: "Home", route: "/home", icon: <IoHomeOutline />, dis: "translate-x-0" },
        { name: "Livetv", route: "/livetv", icon: <MdLiveTv />, dis: "translate-x-[72px]" },
        { name: "Store", route: "/store", icon: <IoMdAppstore />, dis: "translate-x-36" },
        { 
            name: "Profile", 
            route: "/profile", 
            icon: <CgProfile />, 
    ...
    return (
        <div className='flex relative w-screen'>
            ...
            <div className='flex w-screen h-auto px-2 py-1 fixed shadow-2xl bg-white bottom-0 justify-center z-50 items-center rounded-t-xl lg:hidden'>
                <ul className='flex relative gap-2'>
                    {/* Active Indicator */}
                    <span className={`bg-lwfs_blue duration-500 h-16 w-16 ${activeNav ? activeNav.dis : ""} absolute rounded-full border-4 border-white -top-6`}></span>
